...
- 丝印 ![alt text](../.images/PCB/image-12.png)
...
- PCB顶层和底层靠孔连接，所以需要一些连地的孔把顶层和底层接起来（操作方法：打过孔，网络改成GND）
...
- 电路焊接：
  ...
  - 手工焊接：
    - 单点焊接
    - 拖焊
  - 回流焊：是通过重新熔化预先分配到印制板焊盘上的***焊锡膏***，实现表面组装元器件焊端或引脚与印制板焊盘间机械与电气连接的软钎焊。![alt text](../.images/PCB/image-27.png)
